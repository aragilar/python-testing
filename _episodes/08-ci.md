...
> ## Tools to use: appveyor
> [appveyor](https://www.appveyor.com/) is a hosted continuous integration
> service for Microsoft Windows. appveyor comes with many of the tools needed to
> build scientific codes on Windows, and a template config file and further
> information about using appveyor to test Python code can be found at
